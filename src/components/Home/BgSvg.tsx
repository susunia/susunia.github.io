...
export default function BgSvg() {
    return (
        <>
            <svg className="_._w-full" height="1192" viewBox="0 0 1920 1192" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <linearGradient id="paint0_linear_2840_46" x1="2117.79" y1="34.1404" x2="83.2194" y2="768.35" gradientUnits="userSpaceOnUse">
                        <stop offset="0" stopColor="rgba(200 189 255)"></stop>
                        <stop offset="0.13824" stopColor="#BAA6FF"></stop>
                        <stop offset="0.337481" stopColor="#6721FF"></stop>
                        <stop offset="0.900573" stopColor="#180048"></stop>
                        <stop offset="1" stopColor="#00CBFF"></stop>
                    </linearGradient>
                </defs>
            </svg>
        </>
